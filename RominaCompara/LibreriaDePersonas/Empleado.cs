namespace LibreriaDePersonas
{
    public class Empleado
    {
        ...
        //4-Nombre: SIEMPRE el MISMO que la CLASE (Empleado)
        //5-Parametros
        ...
        //------------------------------------------------------------------------------------------------
        //5)-METODOS -> son los compartamientos de mi clase (por lo gral se usan para comunicar info)
