...
namespace FormAlumnos
{
    ...
    {
        //ATRIBUTO
        private Materia miMateria;//atributo privado miMateria de tipo Materia(clase-Biblioteca),que representa
        ...
        public Materia MiMateria //Retorna algo de tipo Materia (MiMateria-com mayuscula)
        {//Hay una propiedad pública MiMateria que devuelve la materia creada cuando se hace clic en el botón "Aceptar".
            get
            {
                return this.miMateria;//se retorna el atributo miMateria (con minuscula)
            }
        }
    }
}
